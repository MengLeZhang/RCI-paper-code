...
write.csv(RCI.tables,file='../Results/Robustness test 1/RCI London point estimates RT1.csv')
...
write.csv(di.raw.tab,file='../Results/Robustness test 1//DI London raw CI.csv')
